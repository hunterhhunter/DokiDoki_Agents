...
from main_back.backend.persona.prompt_template.gpt_structure import *
from main_back.backend.persona.prompt_template.print_prompt import *
...
GPT_template = {
    ...
    "run_gpt_prompt_action_sector" : "action_location_sector.txt",
    "run_gpt_prompt_action_arena" : "action_location_object.txt",
    "run_gpt_prompt_action_game_object" : "action_object.txt",
    "run_gpt_prompt_event_triple" : "generate_event_triple.txt",
    "run_gpt_prompt_act_obj_desc" : "generate_obj_event.txt",
    "run_gpt_prompt_act_obj_event_triple" : "generate_event_triple.txt",
    "run_gpt_prompt_new_decomp_schedule" : "new_decomp_schedule.txt",
    "run_gpt_prompt_decide_to_talk" : "decide_to_talk.txt",
    "run_gpt_prompt_summarize_conversation" : "summarize_conversation.txt",
...
def run_gpt_prompt_daily_plan(persona, 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_daily_plan"]
...
def run_gpt_prompt_generate_hourly_schedule(persona, 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_generate_hourly_schedule"]
  prompt_input = create_prompt_input(persona, 
                                     curr_hour_str, 
                                     p_f_ds_hourly_org,
                                     hour_str, 
...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "text-davinci-002", "max_tokens": 5, 
             ...
             "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_wake_up_hour"]
...
def run_gpt_prompt_event_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_event_poignancy"]
...
def run_gpt_prompt_chat_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["poignancy_chat.txt"]
  prompt_input = create_prompt_input(persona, event_description)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  example_output = "5" ########
  special_instruction = "The output should ONLY contain ONE integer value on the scale of 1 to 10." ########
...
def run_gpt_prompt_task_decomp(persona, 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_task_decomp"]
...
# ['brushing her teeth', 5],
# ['taking a shower', 10],
# ['getting dressed', 10],
# ['eating breakfast', 10],
# ['meditating', 10],
# ['gathering her supplies', 5],
# ['checking the weather', 5]
#   ]
...
def run_gpt_prompt_action_sector(action_description, 
                                ...
                                test_input=None, 
                                verbose=False):
  def create_prompt_input(action_description, persona, location, test_input=None): 
    act_world = f"{location['world']}"
    ...
    prompt_input += [persona.scratch.get_str_name()]
    prompt_input += [f"{location['sector']}"]
    x = f"{act_world}:{location['sector']}"
    prompt_input += [persona.s_mem.get_str_accessible_sector_arenas(x)]
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_action_sector"]
...
def run_gpt_prompt_action_arena(action_description, 
                                persona, 
                                location, act_world, act_sector,
                                test_input=None, 
                                verbose=False):
  def create_prompt_input(action_description, persona, location, act_world, act_sector, test_input=None): 
    prompt_input = []
    # prompt_input += [persona.scratch.get_str_name()]
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_action_arena"]
...
def run_gpt_prompt_action_game_object(action_description, 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_action_game_object"]
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False): 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_event_triple"]
  prompt_input = create_prompt_input(action_description, persona)
  prompt = generate_prompt(prompt_input, prompt_template)
  fail_safe = get_fail_safe(persona) ########
  output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
...
def run_gpt_prompt_act_obj_desc(act_game_object, act_desp, persona, verbose=False): 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_act_obj_desc"]
...
def run_gpt_prompt_act_obj_event_triple(act_game_object, act_obj_desc, persona, verbose=False): 
  ...
  gpt_param = {"engine": "text-davinci-003", "max_tokens": 30, 
               ...
               "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  # prompt_template = "persona/prompt_template/v2/generate_event_triple_v1.txt"
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_act_obj_event_triple"]
...
def run_gpt_prompt_decide_to_talk(persona, target_persona, retrieved,test_input=None, 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_decide_to_talk"]
...
def run_gpt_prompt_summarize_conversation(persona, conversation, test_input=None, verbose=False): 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_summarize_conversation"]
...
def run_gpt_generate_iterative_chat_utt(location, init_persona, target_persona, retrieved, curr_context, curr_chat, test_input=None, verbose=False): 
  def create_prompt_input(location, init_persona, target_persona, retrieved, curr_context, curr_chat, test_input=None):
    ...
    curr_sector = f"{location['sector']}"
    curr_arena= f"{location['arena']}"
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_generate_iterative_chat_utt"]
...
def run_gpt_prompt_agent_chat_summarize_relationship(persona, target_persona, statements, test_input=None, verbose=False): 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_agent_chat_summarize_relationship"]
...
def run_gpt_prompt_decide_to_react(persona, target_persona, retrieved,test_input=None, 
  ...
  prompt_template = "main_back/backend/persona/prompt_template/template/" + GPT_template["run_gpt_prompt_decide_to_react"]
  prompt_input = create_prompt_input(persona, target_persona, retrieved,
                                     test_input)
  prompt = generate_prompt(prompt_input, prompt_template)
