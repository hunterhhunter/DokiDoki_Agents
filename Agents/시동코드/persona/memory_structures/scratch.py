    ...
    if check_if_file_exists(f_saved): 
      ...
      if scratch_load["curr_time"]: 
        self.curr_time = datetime.datetime.strptime(scratch_load["curr_time"],
                                                  "%B %d, %Y, %H:%M:%S")
        print("curr_time_true", scratch_load['curr_time'], self.curr_time)
      else: 
        self.curr_time = None
        print("curr_time_False", scratch_load['curr_time'], self.curr_time)
