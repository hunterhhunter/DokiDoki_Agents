...
현재 character1 은 character2 를 dokidoki 마을의 광장에서 만났습니다. 둘은 처음 보는 사이입니다. character1은 character2 에게 말하려고 합니다.

지시사항: 위의 맥락이 주어졌을 때, character1은 character2에게 무슨 말을 다음에 할 까요?
...
현재 character1 은 character2 를 dokidoki 마을의 광장에서 만났습니다. 둘은 이야기를 나누는 중입니다.
...
def run_gpt_generate_converse_first(캐릭터1, 캐릭터2):
    if custom == True:
        your_first_prompt = your_first_prompt.replace('character1', 캐릭터1)
        your_first_prompt = your_first_prompt.replace('character2', 캐릭터2)
...
def run_gpt_generate_converse_second(캐릭터1, 캐릭터2, 화자=None):
    if custom == True:
        if 화자==캐릭터2:
            캐릭터2_to_캐릭터1 = 캐릭터2_to_캐릭터1.replace('character1', 캐릭터1)
            캐릭터2_to_캐릭터1 = 캐릭터2_to_캐릭터1.replace('character2', 캐릭터2)
            prompt = 캐릭터2_to_캐릭터1
        elif 화자==캐릭터1:
            캐릭터1_to_캐릭터2 = 캐릭터1_to_캐릭터2.replace('character1', 캐릭터1)
            캐릭터1_to_캐릭터2 = 캐릭터1_to_캐릭터2.replace('character2', 캐릭터2)
            prompt = 캐릭터1_to_캐릭터2
    else:
        prompt = tom_to_isabella
    try: 
