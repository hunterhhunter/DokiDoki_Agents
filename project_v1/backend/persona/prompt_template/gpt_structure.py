...
def safe_local_generate_response(prompt,
    ...
    for i in range(repeat):
        ...
        if func_validate(curr_local_response, prompt=prompt):
            print(func_validate(curr_local_response, prompt=prompt))
            return func_clean_up(curr_local_response, prompt=prompt)
